    ...
    return Obx(() {
        ...
        return Stack(
          children: [
            ...
            game.myPlayer.value.isHost() && game.gameStage.value == g.GameStage.lobby
            ? SizedBox(
              width: size.width,
              child: Row(
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            nextSpeaker != null ? 
                              game.gameSettings!.lastWordForKilled 
                              && game.isNoOneSpeaksBefore()
                              && game.killedByMafia.isNotEmpty
                              ? Stack(
                                children: [
                                  Container(
                                    width: 50,
        ...
        game.myPlayer.value.isVoting && game.gameStage.value == g.GameStage.inProgress
                                ...
                                Stack(
                                  children: [
                                    Container(
                                      ...
                                      child: game.killedByMafia.isNotEmpty ? const Center(
                                        child: Icon(
                                          Icons.light_mode_rounded,
                                          color: Colors.white,
                                        )
                                    ...
                                    Material(
                                      ...
                                      child: InkWell(
                                        borderRadius: BorderRadius.circular(40),
                                        onTap: (){
                                          if(game.killedByMafia.isNotEmpty){
                                            game.changePeriod();
                                          }
                                          else{
                                            game.startMafiaTime();
          ...
          (game.myPlayer.value.isHost() || game.myPlayer.value.isMafiaVoter)
            && game.gameStage.value == g.GameStage.inProgress
            && game.currentDayPeriod.value == g.DayPeriod.night
            && game.hasMafiaVoter()
              ?  SizedBox(
            ...
            (game.myPlayer.value.isHost() && game.haveSpeakers() || game.myPlayer.value.isSpeakingTurn)
            && game.gameStage.value == g.GameStage.inProgress
            && game.currentDayPeriod.value == g.DayPeriod.day
                ? SizedBox(
                  width: size.width,
